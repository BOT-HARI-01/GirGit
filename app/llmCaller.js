  ...
  if (model === "gemini-2.0-flash") {
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `You are a helpful assistant. Please clear text and provide correct Intition.
        1. The question or conversation between the interviewer and interviewee
        2. The input can be coding question or template 
